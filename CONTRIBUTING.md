...
This document will hopefully help you contribute to pgvictoria.
...
All contributions to pgvictoria are licensed under the [The 3-Clause BSD License](https://opensource.org/licenses/BSD-3-Clause).
...
Don't forget to indicate your pgvictoria version.
...
You can discuss bug reports, enhancements and features in our [forum](https://github.com/pgvictoria/pgvictoria/discussions).
...
```
git clone git@github.com:yourname/pgvictoria.git
cd pgvictoria
git remote add upstream https://github.com/pgvictoria/pgvictoria.git
```
